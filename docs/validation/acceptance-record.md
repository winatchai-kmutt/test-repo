...
| Source-control configuration | Pass | Force Text, Visible Meta Files, local Git repository, Git LFS filters, tracked configuration and ignored generated folders. No remote or commit exists. |
